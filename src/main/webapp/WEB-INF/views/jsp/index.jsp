...
<head>
    ...
    <meta name="keywords"
          content="jquery, gallery, images, css3, html5, photography, website, template, google maps, sliding, background"/>
    ...
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyBE4kTKvWOOvYoXN3plQJu-Nu9Ht13Yu1I&callback=initMap"
...
<div id="bf_container" class="bf_container">
    <div id="bf_background" class="bf_background">
        <img src="${pageContext.request.contextPath}/resources/images/background/default1.jpg" alt="image1"
             style="display:none;"/>
    ...
    <div class="bf_page" id="about">
        <div class="bf_content_text">
            ...
            <p>We was founded in 2015. We have an italian chef Gabriele Vespucchi, who knows all about a great
                pizza! </p>
    ...
    <div class="bf_page" id="menu">
        <div class="bf_content_text">
            ...
            <ul id="bf_dishes">
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/1.jpg"
                                     alt="thumb1"/></a></li>
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/2.jpg"
                                     alt="thumb2"/></a></li>
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/3.jpg"
                                     alt="thumb3"/></a></li>
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/4.jpg"
                                     alt="thumb4"/></a></li>
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/5.jpg"
                                     alt="thumb5"/></a></li>
                <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/thumbs/6.jpg"
                                     alt="thumb6"/></a></li>
            </ul>
        </div>
            ...
            <div class="bf_gallery_wrapper">
                <div class="bf_gallery_item">
                    ...
                    <div class="bf_desc">
                        ...
                        <h4>Price: 120.00 UAH</h4>
                        <h4 style="bottom: 0px">Ingredients: olives, bacon, mushrooms, salad, cream</h4>
                    </div>
                    <img src="${pageContext.request.contextPath}/resources/images/foreground/1.jpg" alt="image1"
                         data-bgimg="${pageContext.request.contextPath}/resources/images/background/1.jpg"/>
                </div>
                <div class="bf_gallery_item">
